...
void Snippet(int x0) {
  ...
  // end initializing fixed GPU array of size 256 and type Float and device (pre-rename) x39
  // begin computing MULT on GPU for size 256 and type Float at device (pre-rename) x39 with left_operand x45 and right_operand x280
  CUDA_CALL(cudaSetDevice(x6));
  ...
  // end computing MULT on GPU for size 256 and type Float at device (pre-rename) x39 with left_operand x45 and right_operand x280
  // begin computing ACCUM on GPU for size 256 and type Float at device (pre-rename) x39 with base_operand x243 and addition_operand x293
  CUDA_CALL(cudaSetDevice(x6));
  x47<<<dim3(28, 1, 1), dim3(512, 1, 1)>>>(x42, x46, 256);
  // end computing ACCUM on GPU for size 256 and type Float at device (pre-rename) x39 with base_operand x243 and addition_operand x293
  ...
  // begin computing ACCUM on GPU for size 256 and type Float at device (pre-rename) x39 with base_operand x62 and addition_operand x343
  CUDA_CALL(cudaSetDevice(x6));
  x47<<<dim3(28, 1, 1), dim3(512, 1, 1)>>>(x9, x54, 256);
  // end computing ACCUM on GPU for size 256 and type Float at device (pre-rename) x39 with base_operand x62 and addition_operand x343
  ...
  // begin computing ACCUM on GPU for size 512 and type Float at device (pre-rename) x39 with base_operand x230 and addition_operand x363
  CUDA_CALL(cudaSetDevice(x6));
  x47<<<dim3(28, 1, 1), dim3(512, 1, 1)>>>(x41, x55, 512);
  // end computing ACCUM on GPU for size 512 and type Float at device (pre-rename) x39 with base_operand x230 and addition_operand x363
  ...
  check_float_array_rank("golden/weight_grad", x6, (float*)malloc(256 * sizeof(float)), x67, 256);
  ...
  check_float_array_rank("golden/input_grad", x6, (float*)malloc(512 * sizeof(float)), x68, 512);
