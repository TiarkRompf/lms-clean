...
void Snippet(int x0) {
  ...
  check_float_array(x32, 162, "golden/loss_rank_%d.data", x6);
  ...
  check_float_array(x57, 18, "golden/weight_grad_rank_%d.data", x6);
  ...
  check_float_array(x58, 81, "golden/input_grad_rank_%d.data", x6);
