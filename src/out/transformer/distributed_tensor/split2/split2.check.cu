...
void Snippet(int x0) {
  ...
  check_float_array(x44, 256, "golden/loss_rank_%d.data", x6);
  ...
  check_float_array(x68, 512, "golden/weight_grad_rank_%d.data", x6);
  ...
  check_float_array(x69, 256, "golden/input_grad_rank_%d.data", x6);
  // end checking GPU array of size 256 and type Float
