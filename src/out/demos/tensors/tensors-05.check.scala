...
def tensors_05(x0: Int): Int /* x1 */ = {
  ...
  println(x5)/* val x6 = [x5 "CTRL"*: _ | x1, x5] */
  println(tensor_add1(x5, x2))/* val x7 = [x8 "CTRL"*: _ | x6, x8] */
  0 /* x7 */
}
...
def tensors_05(x0: Int): Int /* x1 */ = {
  ...
  println(x5)/* val x9 = [x5 "CTRL"*: _ | x1, x5] */
  println(Tensor1(List(3, 4, 5), (x10: Int) /* x11 */ => tensor_apply(x5, x10) + tensor_apply(x2, x10) /* x11 */))/* val x12 = [x13 "CTRL"*: _ | x9, x13] */
  0 /* x12 */
}
...
def tensors_05(x0: Int): Int /* x1 */ = {
  val x2 = TensorBuilder1(List(3, 4, 5))/* val x2 = ["STORE" : _ | x1] */
  val x3 = forloops(List(3, 4, 5), { (x4: Int) /* x5 */ =>
    val x6 = seq_apply(x4, 0) + seq_apply(x4, 1) + seq_apply(x4, 2)
    val x7 = builder_add(x2, x4, x6 + x6)/* val x7 = [x2*: _ | x5] */
    /* x7 */
  })/* val x3 = [x2*: _ | x2] */
  println(builder_res(x2)/* val x8 = [x2*: _ | x3] */)/* val x9 = [x8 "CTRL"*: _ | x1, x8] */
  val x10 = TensorBuilder1(List(3, 4, 5))/* val x10 = ["STORE" : _ | x1] */
  val x11 = forloops(List(3, 4, 5), { (x12: Int) /* x13 */ =>
    val x14 = seq_apply(x12, 0) + seq_apply(x12, 1) + seq_apply(x12, 2)
    val x15 = builder_add(x10, x12, x14 + x14 + x14)/* val x15 = [x10*: _ | x13] */
    /* x15 */
  })/* val x11 = [x10*: _ | x10] */
  println(builder_res(x10)/* val x16 = [x10*: _ | x11] */)/* val x17 = [x16 "CTRL"*: _ | x9, x16] */
  0 /* x17 */
}
// After Tensor fusion H2:
def tensors_05(x0: Int): Int /* x1 */ = {
  val x2 = TensorBuilder1(List(3, 4, 5))/* val x2 = ["STORE" : _ | x1] */
  val x3 = TensorBuilder1(List(3, 4, 5))/* val x3 = ["STORE" : _ | x1] */
